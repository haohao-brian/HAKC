...
#define THREAD_KEYS_USER 3624 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3704 /* offsetof(struct task_struct, thread.keys_kernel) */
